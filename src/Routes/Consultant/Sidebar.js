	...
	return (
		<div>
			...
			: 'bg-transparent text-[#0D0D0D]} rounded-l-3xl text-sm font-semibold">
						...
						<a href="ConDashboard" class="font-normal pl-3"><h5>Home</h5></a>
			...
			: 'bg-transparent text-gray-400'} rounded-l-3xl text-sm font-semibold "
					>
						...
						<a href="/Consultant" class="font-normal pl-3"><h5>Consultants</h5></a>
			...
			: 'bg-transparent text-gray-400'} rounded-l-3xl text-sm font-semibold"
					><img src={Patients} alt="Logo" class='w-4 h-4' />
						<a href="/" class="font-normal pl-3"><h5>Patient</h5></a>
					</li>
					<li
			...
			: 'bg-transparent text-gray-400'} rounded-l-3xl text-sm font-semibold"
				><img src={SignOut} alt="Logo" class='w-4 h-4' />
					<a href="/" class="font-normal pl-3"><h5>Sign Out</h5></a>
				</li>
