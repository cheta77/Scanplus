...
import { BsArrowUpRight, BsChevronDown, BsHouse, BsOutlet } from 'react-icons/bs';
	...
	return (
		<div>
			...
			: 'bg-transparent text-[#0D0D0D]} rounded-l-3xl text-sm font-semibold">
						...
						<a href="Dashboard" class="font-normal pl-3"><h5>Home</h5></a>
			...
			: 'bg-transparent text-gray-400'} rounded-l-3xl text-sm font-semibold "
					>
						...
						<a href="/Consultants" class="font-normal pl-3"><h5>Consultants</h5></a>
			...
			: 'bg-transparent text-gray-400'} rounded-l-3xl text-sm font-semibold"
					><img src={Radiographers} alt="Logo" class='w-4 h-4' />
						<a href="/" class="font-normal pl-3"><h5>Radiographers</h5></a>
					</li>
					<li
			...
			: 'bg-transparent text-gray-400'} rounded-l-3xl text-sm font-semibold"
					><img src={Patients} alt="Logo" class='w-4 h-4' />
						<a href="Patients" class="font-normal pl-3"><h5>Patient</h5></a>
					</li>
					<li
			...
			: 'bg-transparent text-gray-400'} rounded-l-3xl text-sm font-semibold"
					><img src={Report} alt="Logo" class='w-4 h-4' />
						<a href="/Report" class="font-normal pl-3"><h5>Report</h5></a>
					</li>
				</div>
			...
			: 'bg-transparent text-gray-400'} rounded-l-3xl text-sm font-semibold"
				><img src={SignOut} alt="Logo" class='w-4 h-4' />
					<a href="/Login" class="font-normal pl-3"><h5>Sign Out</h5></a>
				</li>
				...
				<div class='flex px-2 py-2 items-center border-[#1C4D94] border-l border-t border-b border-r rounded-md mt-10 space-x-2'>
					...
					<Menu menuStyle={{ paddingLeft: 30, paddingRight: 30, borderRadius: 10, }} menuButton={<MenuButton class='color-[#383A47] font-normal text-xs'>Sylvia Hopkin</MenuButton>}>
						<Link to="/Dashboard" >
							<MenuItem style={{ marginTop: '10%' }}>Hospital</MenuItem>
						</Link>
						<MenuItem style={{ marginTop: '10%' }}>Pharmacy</MenuItem>
