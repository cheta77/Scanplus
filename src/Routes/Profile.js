                ...
                <div class=" justify-between items-center  py-4 px-4 bg-white rounded-2xl  mt-6">
                    <div class="flex  items-center  space-x-4  mt-3">
                        <div class="w-90  flex  items-center  space-x-3">
                            ...
                            <div>
                                <h6 class="font-semibold text-[#494646] text-sm">
                                    Kim Builer{" "}
                                </h6>
                                <h6 class="text-sm md:text-sm sm:text-xs font-light text-[#3F3F3F]">
                                    Hello Christine, I just receiv...{" "}
                                </h6>
                            </div>
                        </div>
                        <div>
                ...
                <div class="justify-center items-center  py-8 px-3 bg-white rounded-2xl  mt-6">
                    <div class="flex px-1">
                        <div class=" justify-center items-center">
                            <h1 class="text-black text-sm font-semibold">
                                Manage Radiographers
                            </h1>
                            <h6 class="mt-2 font-medium text-xs">
                                The copy goes here on a <br />
                                special feature to make
                                <br /> vendor management easy
                            </h6>
                        </div>
                        <img
                            src={Verified}
                            alt="file"
                            class="w-14 h-13 mt-8 ml-1"
                        />
                    </div>
