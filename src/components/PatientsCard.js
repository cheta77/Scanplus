...
function PatientsCard(props) {
	return (
		<div
			class="flex justify-center items-center space-x-4 py-1.5 px-1.5 bg-white rounded-2xl w-48 md:w-60 lg:w-52 sm:w-40"
		>
			<div class="flex justify-center items-center lg:space-x-6 space-x-4">
				<div class="w-10 md:w-12 h-10 md:h-12 flex-none">
					...
					>
						<div><img src={props.ImgUrl} class="w-5 h-5" /></div>
					</div>
				</div>

				<div>
					<h5 class="text-xs md:text-xs sm:text-xs font-semibold text-gray-600">Total Consultants</h5>
